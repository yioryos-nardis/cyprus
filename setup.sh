...
git subtree add --prefix=public \
    git@github.com:yioryos-nardis/yioryos-nardis.github.io.git master --squash
msg "Pulling down the just committed file to help avoid merge conflicts"
git subtree pull --prefix=public \
    git@github.com:yioryos-nardis/yioryos-nardis.github.io.git master